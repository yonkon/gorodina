...
$urlka = str_replace('/avtomoyka/', '',$urlka); /* удалил слеш “/” в начале файлы */
...
<title>Автомойки <?=$myrow['rpadej'];?> - <?=$myrow['region'];?>. Сервисы мойки авто на карте.</title>
<meta name="description" content="Найти автомойки в городе <?=$myrow['name'];?>. Узнайте где в ближайшем месте помыть вашу машину." />
<meta name="keyword" content="<?=$myrow['name'];?>, карта, мойка, автомойка, машина, авто, автомобиль, <?=$myrow['region'];?>, яндекс, спутник" />
...
<h1>Автомойки <?=$myrow['rpadej'];?></h1>

<div id="map-canvas"></div>
<i>*Точки на карте обозначают расположение автомоек в городе <?=$myrow['name'];?></i>
