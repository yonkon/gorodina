...
$urlka = str_replace('/work/', '',$urlka); /* удалил слеш “/” в начале файлы */
...
<title>Работа и вакансии города <?=$myrow['rpadej'];?>. Поиск работы <?=$myrow['region'];?>.</title>
<meta name="description" content="Поиск работы и подбор вакансий города <?=$myrow['name'];?>. Посмотреть предложения для работников и работадателей." />
<meta name="keyword" content="<?=$myrow['name'];?>, работа, вакансии, <?=$myrow['region'];?>, поиск, подбор" />
...
<h1>Работа <?=$myrow['rpadej'];?></h1>

 <iframe src="js.php" width="590" height="600" align="left">
