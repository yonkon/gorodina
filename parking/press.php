...
$urlka = str_replace('/parking/', '',$urlka); /* удалил слеш “/” в начале файлы */
...
<title>Парковки в <?=$myrow['rpadej'];?> - <?=$myrow['region'];?>. Расположение автостоянок на карте.</title>
<meta name="description" content="Парковки расположенные в городе <?=$myrow['name'];?>. Все автостоянки (платные и бесплатные) на карте." />
<meta name="keyword" content="<?=$myrow['name'];?>, карта, стоянка, автостоянка, парковка, машина, авто, автомобиль, <?=$myrow['region'];?>, яндекс, спутник" />
...
<h1>Автопарковки <?=$myrow['rpadej'];?></h1>

<div id="map-canvas"></div>
<i>*Точки на карте обозначают расположение автостоянок в городе <?=$myrow['name'];?></i>
</div>
